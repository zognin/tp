...
import static seedu.btbb.logic.commands.CommandTestUtil.NAME_DESC_BOB;
...
import static seedu.btbb.logic.commands.CommandTestUtil.PREAMBLE_NON_EMPTY;
import static seedu.btbb.logic.commands.CommandTestUtil.PREAMBLE_WHITESPACE;
...
public class AddClientCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB, new AddClientCommand(expectedClientDescriptor));
