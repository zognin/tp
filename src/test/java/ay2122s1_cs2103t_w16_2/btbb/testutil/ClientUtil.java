...
public class ClientUtil {
    ...
    public static String getClientDetails(Client client) {
        ...
        sb.append(PREFIX_CLIENT_NAME + client.getName().toString() + " ");
        sb.append(PREFIX_CLIENT_PHONE + client.getPhone().toString() + " ");
        sb.append(PREFIX_CLIENT_EMAIL + client.getEmail().toString() + " ");
        sb.append(PREFIX_CLIENT_ADDRESS + client.getAddress().toString() + " ");
        return sb.toString();
    }
    ...
    public static String getEditClientDescriptorDetails(ClientDescriptor descriptor) {
        StringBuilder sb = new StringBuilder();
        descriptor.getName().ifPresent(name -> sb.append(PREFIX_CLIENT_NAME).append(name).append(" "));
        descriptor.getPhone().ifPresent(phone -> sb.append(PREFIX_CLIENT_PHONE).append(phone).append(" "));
        descriptor.getEmail().ifPresent(email -> sb.append(PREFIX_CLIENT_EMAIL).append(email).append(" "));
        descriptor.getAddress().ifPresent(address -> sb.append(PREFIX_CLIENT_ADDRESS).append(address).append(" "));
        return sb.toString();
    }
}
